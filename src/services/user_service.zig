...
pub const UserService = struct {
    ...
    pub fn createUser(ptr: *anyopaque, payload: NewUserPayload) AppError!?i64 {
    ...
    pub fn findUser(ptr: *anyopaque, uid: []const u8) AppError!UserResponse {
    ...
    pub fn listUsers(ptr: *anyopaque) AppError![]UserResponse {
        var self: *UserService = @ptrCast(@alignCast(ptr));
    ...
    pub fn updateUser(ptr: *anyopaque, uid: []const u8, payload: UpdateUserPayload) AppError!?i64 {
        const self: *UserService = @ptrCast(@alignCast(ptr));
    ...
    pub fn deleteUser(ptr: *anyopaque, uid: []const u8) AppError!?i64 {
        var self: *UserService = @ptrCast(@alignCast(ptr));
